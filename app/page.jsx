...
export default function HomePage() {
  ...
  // 用户认证状态（服务端 cookie 持久化；用户信息由 zustand 全局管理）
  ...
  const handleCandidateAddFund = useCallback((fundInfo) => {
  ...
  }, [setScannedFunds, setSelectedScannedCodes, setIsOcrScan, setScanConfirmModalOpen]);
  ...
  const mobileHomeTabVisible = mainTab === 'home';
  ...
  const getFundCardPropsForRow = useCallback(
    (row) => {
      ...
      return {
        ...
        onAddFund: handleCandidateAddFund,
    ...
    >
              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  ...
                  >
                    ...
                    >
                      <rect x="5" y="3" width="14" height="18" rx="2.2" fill="var(--surface)" stroke="var(--accent)" strokeWidth="1.8" />
                      <path d="M15 3v4.2c0 .7.6 1.3 1.3 1.3H19" stroke="var(--accent)" strokeWidth="1.4" strokeLinecap="round" strokeLinejoin="round" />
                      <path d="M8 14l2.8-3.2 2.6 2 3.6-5.1" stroke="var(--primary)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                      <path d="M8 17.5h8" stroke="var(--muted)" strokeWidth="1.6" strokeLinecap="round" />
                    </svg>
                  </div>
                </TooltipTrigger>
                <TooltipContent>
      ...
      {isMobile && (
        <MineTab
          ...
          onSponsorSupport={undefined}
          onOpenWeChat={undefined}
        />
      )}
